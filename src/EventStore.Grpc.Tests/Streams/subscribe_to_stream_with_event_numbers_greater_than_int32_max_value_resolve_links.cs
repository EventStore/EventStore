...
namespace EventStore.Grpc.Tests.Streams {
	public class subscribe_to_stream_with_event_numbers_greater_than_int32_max_value_resolve_links
		: IClassFixture<subscribe_to_stream_with_event_numbers_greater_than_int32_max_value_resolve_links.Fixture> {
		private const string Stream =
			nameof(subscribe_to_stream_with_event_numbers_greater_than_int32_max_value_resolve_links);

		private const string LinkedStream = "linked-" + Stream;
		private readonly Fixture _fixture;

		public subscribe_to_stream_with_event_numbers_greater_than_int32_max_value_resolve_links(Fixture fixture) {
			_fixture = fixture;
		}
		...
		public async Task should_subscribe() {
			...
			using var _ = _fixture.Client.SubscribeToStreamAsync(
				Stream, StreamRevision.Start, true, EventAppeared, SubscriptionDropped);
