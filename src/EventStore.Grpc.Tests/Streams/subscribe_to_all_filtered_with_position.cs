...
namespace EventStore.Grpc.Streams {
	public class subscribe_to_all_filtered_with_position
		: IClassFixture<subscribe_to_all_filtered_with_position.Fixture> {
		private readonly Fixture _fixture;

		public subscribe_to_all_filtered_with_position(Fixture fixture) {
			_fixture = fixture;
		}
