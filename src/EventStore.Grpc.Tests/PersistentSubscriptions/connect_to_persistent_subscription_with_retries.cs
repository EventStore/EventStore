...
namespace EventStore.Grpc.Tests.PersistentSubscriptions {
	...
	public class connect_to_persistent_subscription_with_retries
		: IClassFixture<connect_to_persistent_subscription_with_retries.Fixture> {
		private readonly Fixture _fixture;
		private const string Group = "retries";

		private const string Stream = nameof(connect_to_persistent_subscription_with_retries);

		public connect_to_persistent_subscription_with_retries(Fixture fixture) {
			_fixture = fixture;
		}
