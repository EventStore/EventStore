...
namespace EventStore.Grpc.Tests.PersistentSubscriptions {
	[Collection(nameof(StandaloneKestrelServerTestCollection))]
	public class connect_to_persistent_subscription_with_link_to_event_with_event_number_greater_than_int_maxvalue
		: IClassFixture<
			connect_to_persistent_subscription_with_link_to_event_with_event_number_greater_than_int_maxvalue.Fixture> {
		private readonly Fixture _fixture;

		private const string Stream =
			nameof(connect_to_persistent_subscription_with_link_to_event_with_event_number_greater_than_int_maxvalue);

		private const string Group = nameof(Group);

		public connect_to_persistent_subscription_with_link_to_event_with_event_number_greater_than_int_maxvalue(
			Fixture fixture) {
			_fixture = fixture;
		}
