...
namespace EventStore.Grpc.Tests.PersistentSubscriptions {
	...
	public class deleting_existing_persistent_subscription_with_subscriber
		: IClassFixture<deleting_existing_persistent_subscription_with_subscriber.Fixture> {
		private readonly Fixture _fixture;
		private const string Stream = nameof(deleting_existing_persistent_subscription_with_subscriber);

		public deleting_existing_persistent_subscription_with_subscriber(Fixture fixture) {
			_fixture = fixture;
		}
