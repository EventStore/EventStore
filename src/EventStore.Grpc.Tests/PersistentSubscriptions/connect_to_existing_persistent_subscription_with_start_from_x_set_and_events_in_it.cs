...
namespace EventStore.Grpc.Tests.PersistentSubscriptions {
	...
	public class connect_to_existing_persistent_subscription_with_start_from_x_set_and_events_in_it
		: IClassFixture<connect_to_existing_persistent_subscription_with_start_from_x_set_and_events_in_it.Fixture> {
		private readonly Fixture _fixture;
		private const string Group = "startinx2";

		private const string Stream =
			nameof(connect_to_existing_persistent_subscription_with_start_from_x_set_and_events_in_it);
