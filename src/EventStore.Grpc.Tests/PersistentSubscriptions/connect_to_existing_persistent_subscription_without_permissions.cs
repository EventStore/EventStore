...
namespace EventStore.Grpc.Tests.PersistentSubscriptions {
	...
	public class connect_to_existing_persistent_subscription_without_permissions
		...
		private const string Stream = "$" + nameof(connect_to_existing_persistent_subscription_without_permissions);
		private readonly Fixture _fixture;
		public connect_to_existing_persistent_subscription_without_permissions(Fixture fixture) { _fixture = fixture; }
