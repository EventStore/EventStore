...
namespace EventStore.Grpc.Tests.PersistentSubscriptions {
	...
	public class connect_to_existing_persistent_subscription_with_start_from_two_and_no_stream
		: IClassFixture<connect_to_existing_persistent_subscription_with_start_from_two_and_no_stream.Fixture> {
		private readonly Fixture _fixture;
		private const string Group = "startinbeginning1";

		private const string Stream =
			nameof(connect_to_existing_persistent_subscription_with_start_from_two_and_no_stream);
