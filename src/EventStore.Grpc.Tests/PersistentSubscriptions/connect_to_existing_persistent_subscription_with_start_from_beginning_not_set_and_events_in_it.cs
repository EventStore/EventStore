...
namespace EventStore.Grpc.Tests.PersistentSubscriptions {
	...
	public class connect_to_existing_persistent_subscription_with_start_from_beginning_not_set_and_events_in_it
		...
		private const string Stream =
			nameof(connect_to_existing_persistent_subscription_with_start_from_beginning_not_set_and_events_in_it);

		public connect_to_existing_persistent_subscription_with_start_from_beginning_not_set_and_events_in_it(
			Fixture fixture) {
			_fixture = fixture;
		}
