...
public class MetricsEndpointTests {
	...
	static IEnumerable<string> EventStoreMetrics => [
		...
		"eventstore_io_record_read_duration_seconds_bucket",
		"eventstore_io_record_read_duration_seconds_count",
		"eventstore_io_record_read_duration_seconds_sum",
		...
		"eventstore_queue_processing_duration_seconds_count",
		"eventstore_queue_processing_duration_seconds_sum",
