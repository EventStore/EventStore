...
public class PersistentSubscriptionLastCheckpointedEventMetricTests : IDisposable{
	private readonly Disposables _disposables = new();
	private readonly List<MonitoringMessage.PersistentSubscriptionInfo> _fakeStatistics = [];

	public PersistentSubscriptionLastCheckpointedEventMetricTests() {
	...
	private (PersistentSubscriptionLastCheckpointedEventMetric, TestMeterListener<long>) GenSut(
		...
		var sut = new PersistentSubscriptionLastCheckpointedEventMetric(meter, "test-metric");
