...
public class ConnectorsPlugin : ConnectorsPluginBase, IConnectedSubsystemsPlugin {
	...
	public override (bool Enabled, string EnableInstructions) IsEnabled(IConfiguration configuration) {
		var enabled = configuration.GetValue($"{KurrentConfigurationKeys.Prefix}:Plugins:Connectors:Enabled", defaultValue: false);
		return (enabled, $"Set '{KurrentConfigurationKeys.Prefix}:Plugins:Connectors:Enabled' to 'true' to enable ConnectorsPreview");
	}
