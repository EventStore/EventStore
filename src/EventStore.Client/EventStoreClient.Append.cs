	...
	public partial class EventStoreClient {
		...
		private async Task<WriteResult> AppendToStreamInternal(
			...
			try {
				...
				_log.LogTrace(exc, "Got RpcException when appending event to streams - {streamName}. This is perfectly normal if the connection was closed from the server-side.", header.Options.StreamName);
			}
