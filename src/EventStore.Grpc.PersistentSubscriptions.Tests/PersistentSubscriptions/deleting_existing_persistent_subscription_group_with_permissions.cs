...
namespace EventStore.Grpc.PersistentSubscriptions {
	public class deleting_existing_persistent_subscription_group_with_permissions
		: IClassFixture<deleting_existing_persistent_subscription_group_with_permissions.Fixture> {
		private const string Stream = nameof(deleting_existing_persistent_subscription_group_with_permissions);
		private readonly Fixture _fixture;

		public deleting_existing_persistent_subscription_group_with_permissions(Fixture fixture) {
			_fixture = fixture;
		}
