...
namespace EventStore.Grpc.PersistentSubscriptions {
	public class create_persistent_subscription_after_deleting_the_same
		: IClassFixture<create_persistent_subscription_after_deleting_the_same.Fixture> {
		public create_persistent_subscription_after_deleting_the_same(Fixture fixture) {
			_fixture = fixture;
		}

		private const string Stream = nameof(create_persistent_subscription_after_deleting_the_same);
