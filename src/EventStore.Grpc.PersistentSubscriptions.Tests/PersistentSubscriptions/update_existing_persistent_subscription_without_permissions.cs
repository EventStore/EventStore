...
namespace EventStore.Grpc.PersistentSubscriptions {
	public class update_existing_persistent_subscription_without_permissions
		: IClassFixture<update_existing_persistent_subscription_without_permissions.Fixture> {
		private const string Stream = nameof(update_existing_persistent_subscription_without_permissions);
		private const string Group = "existing";
		private readonly Fixture _fixture;

		public update_existing_persistent_subscription_without_permissions(Fixture fixture) {
			_fixture = fixture;
		}
