...
{
    [TestFixture]
    class when_handling_stop_message : specification_with_projection_manager_command_writer
    {
        ...
        {
            var command = AssertParsedSingleCommand<ProjectionCoreServiceCommandReader.StopCommand>("$stop", _workerId);
