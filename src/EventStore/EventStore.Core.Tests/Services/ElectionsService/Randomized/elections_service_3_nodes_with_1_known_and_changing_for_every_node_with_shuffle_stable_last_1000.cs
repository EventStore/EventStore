...
{
    [TestFixture, Ignore]
    public class elections_service_3_nodes_with_1_known_and_changing_for_every_node_with_shuffle_stable_last_1000
    {
        ...
        {
            return new[] { MemberInfo.ForVNode(instance.InstanceId, DateTime.UtcNow, VNodeState.Unknown, true, 
                            instance.EndPoint, 
                            null,
                            instance.EndPoint, 
                            null,
                                                 ...
                                                 Dictionary<IPEndPoint, MemberInfo[]> previousGossip)
        {
            ...
            if (_randomCase.Next(100) < GossipUpdateParams.KillNodeProbabilityPercent && (iteration < ElectionParams.MaxIterationCount - 1000))
