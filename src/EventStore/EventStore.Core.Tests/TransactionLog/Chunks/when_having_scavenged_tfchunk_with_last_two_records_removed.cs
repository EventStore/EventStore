...
{
    [TestFixture]
    public class when_having_scavenged_tfchunk_with_last_two_records_removed: SpecificationWithDirectoryPerTestFixture
    {
        ...
        [Test]
        public void the_last_record_read_is_record1()
        {
        ...
        {
            var res = _scavengedChunk.TryReadClosestBackwards((int)_res1.OldPosition);
            Assert.IsFalse(res.Success);
        }
    }
}