...
namespace EventStore.TestClient.Commands.RunTestScenarios
{
    ...
    {
        public ProjectionsScenario1(Action<byte[]> directSendOverTcp, int maxConcurrentRequests, int connections, int streams, int eventsPerStream, int streamDeleteStep)
