...
if not exist "%1\..\EventStore.Common\Properties\ESVersion.txt" goto ES_VERSION_NOT_FOUND
if not exist "%1\..\EventStore.ClientAPI\Properties\ESCAVersion.txt" goto ESCA_VERSION_NOT_FOUND
...
set /p _esca_version=<"%1\..\EventStore.ClientAPI\Properties\ESCAVersion.txt"
...
fc %_es_tmpfile% "%1\..\EventStore.Common\Properties\AssemblyVersion.cs" && goto IDENTICAL_ES
copy /y %_es_tmpfile% "%1\..\EventStore.Common\Properties\AssemblyVersion.cs"
:IDENTICAL_ES
fc %_esca_tmpfile% "%1\..\EventStore.ClientAPI\Properties\AssemblyVersion.cs" && goto IDENTICAL_ESCA
copy /y %_esca_tmpfile% "%1\..\EventStore.ClientAPI\Properties\AssemblyVersion.cs"
:IDENTICAL_ESCA
del %_es_tmpfile%
del %_esca_tmpfile%
exit /b 0
