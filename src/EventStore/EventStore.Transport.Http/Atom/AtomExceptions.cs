...
namespace EventStore.Transport.Http.Atom
{
    public class AtomSpecificationViolationException : Exception
    {
        ...
        public AtomSpecificationViolationException(string message, Exception innerException) : base(message, innerException)
        {
        }

        protected AtomSpecificationViolationException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
