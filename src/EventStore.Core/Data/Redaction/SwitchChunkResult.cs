	...
	public static class SwitchChunkResultExtensions {
		public static string GetErrorMessage(this SwitchChunkResult result) {
			return result switch {
				...
				SwitchChunkResult.TargetChunkNumberNotFound => "Failed to retrieve the target chunk with the specified number.",
				SwitchChunkResult.TargetChunkInactive => "The target chunk file is no longer actively used by the database.",
