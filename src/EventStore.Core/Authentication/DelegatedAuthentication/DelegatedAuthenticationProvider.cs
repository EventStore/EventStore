...
// public class DelegatedAuthenticationProvider(AuthenticationProviderBase inner) : AuthenticationProviderBase(new() {
// 	Name = inner.Name,
...
// })  {
// 	public AuthenticationProviderBase Inner { get; } = inner;
//
