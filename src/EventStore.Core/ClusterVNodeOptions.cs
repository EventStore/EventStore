...
namespace EventStore.Core {
	public partial record ClusterVNodeOptions {
		...
		public record DatabaseOptions {
			...
			[Description("The amount of memory & disk space, in bytes, to use for the stream name existence filter (applies to Log V3 format only). " +
			...
			public long StreamExistenceFilterSize { get; init; } = 256_000_000L;
