...
namespace EventStore.Core.Services.Replication {
	public class ReplicaStorageWriterService {
	}

	public class ReplicaStorageWriterService<TStreamId> : StorageWriterService<TStreamId>,
		...
		private static readonly ILogger Log = Serilog.Log.ForContext<ReplicaStorageWriterService>();
		...
		public ReplicaStorageWriterService(IPublisher bus,
