...
namespace EventStore.Core.Services.Transport.Http {
	public static class Format {
		...
		public static string FilteredReadAllEventsBackwardCompleted(HttpResponseFormatterArgs entity, Message message,
			EmbedLevel embed) {
		...
		public static string FilteredReadAllEventsForwardCompleted(HttpResponseFormatterArgs entity, Message message,
			EmbedLevel embed) {
			var msg = message as ClientMessage.FilteredReadAllEventsForwardCompleted;
			if (msg == null || msg.Result != ReadAllFilteredResult.Success)
				return String.Empty;

			return entity.ResponseCodec.To(Convert.ToFilteredAllEventsForwardFeed(msg, entity.ResponseUrl, embed));
		}
