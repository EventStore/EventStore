...
{
    public struct IndexReadAllFilteredResult
    {
        ...
        public IndexReadAllFilteredResult(List<CommitEventRecord> records, TFPos currentPos, TFPos nextPos, TFPos prevPos, bool isEndOfStream)
        {
