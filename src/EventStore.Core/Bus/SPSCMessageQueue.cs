...
namespace EventStore.Core.Bus
{
    ...
    public sealed class SPSCMessageQueue : ISingleConsumerMessageQueue
    {
        ...
        [FieldOffset(Padding + CacheLineSize*3)] private volatile IntPtr sequenceForConsumer;

        [FieldOffset(Padding + CacheLineSize*4)] private volatile IntPtr sequenceReadTo;
        [FieldOffset(Padding + CacheLineSize*5)] private volatile IntPtr sequenceReadToCache;

        [FieldOffset(Padding + CacheLineSize*6)] private long sequenceReadToValue;
        [FieldOffset(Padding + CacheLineSize*7)] public long padding;
