...
public class UserCertificatesPlugin : SubsystemsPlugin {
	...
	public override (bool Enabled, string EnableInstructions) IsEnabled(IConfiguration configuration) {
		var enabled = configuration.GetValue("EventStore:UserCertificates:Enabled", defaultValue: false);
		return (enabled, "Set 'EventStore:UserCertificates:Enabled' to 'true' to enable user X.509 certificate authentication");
	}
