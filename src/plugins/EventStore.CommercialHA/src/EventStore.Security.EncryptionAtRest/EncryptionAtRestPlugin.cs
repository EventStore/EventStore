...
public class EncryptionAtRestPlugin() : SubsystemsPlugin(requiredEntitlements: ["ENCRYPTION_AT_REST"]) {
	const string ConfigRoot = "EventStore:EncryptionAtRest";
	...
	public override (bool Enabled, string EnableInstructions) IsEnabled(IConfiguration configuration) {
		...
		return (enabled, "Set 'EventStore:EncryptionAtRest:Enabled' to 'true' to enable the encryption at rest plugin");
	}
