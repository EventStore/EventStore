...
namespace EventStore.ClientAPI.Embedded
{
        ...
        IHandle<ClientMessage.PersistentSubscriptionStreamEventAppeared>
    {
        ...
        {
            ConfirmSubscription(message.CorrelationId, message.LastCommitPosition, 
                message.LastEventNumber == null ? (int?)null :
                (int?)StreamVersionConverter.Downgrade(message.LastEventNumber.Value));
        }
