...
namespace EventStore.ClientAPI.ClientOperations {
	internal class
		ReadAllEventsBackwardsFilteredOperation : OperationBase<AllEventsSlice,
		...
		public ReadAllEventsBackwardsFilteredOperation(ILogger log, TaskCompletionSource<AllEventsSlice> source,
			...
			: base(log, source, TcpCommand.ReadAllEventsBackwardFiltered,
				TcpCommand.ReadAllEventsBackwardFilteredCompleted,
				userCredentials) {
			_position = position;
			_maxCount = maxCount;
