...
{
    [TestFixture]
    public class when_receiving_statistics_report_response : specification_with_projection_manager_response_reader_started
    {
        ...
        public void publishes_statistics_report_message()
        {
            ...
            Assert.AreEqual(_writePendingEventsBeforeCheckpoint, response.Statistics.WritePendingEventsBeforeCheckpoint);
