...
{
    public class when_response_reader_starts_before_command_reader : specification_with_command_reader_and_response_reader
    {
    ...
    public class when_response_reader_starts_before_command_reader_with_two_workers : specification_with_command_reader_and_response_reader
    {
        protected override void Given()
        {
            _numberOfWorkers = 2;
