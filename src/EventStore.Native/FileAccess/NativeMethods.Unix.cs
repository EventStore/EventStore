...
namespace positional_writes
{
    internal static unsafe partial class NativeMethods
    {
        ...
        public static SafeFileHandle UnixCreateRW(string path, FileAccess acc, FileShare share, FileMode mode) {
        ...
        public static SafeFileHandle UnixCreateUnbufferedRW(string path, FileAccess acc, FileShare share, FileMode mode) {
            //O_RDONLY is 0
        ...
        private static OpenFlags UnixGetFlags(FileAccess acc, FileMode mode) {
        ...
        public static void UnixSeek(SafeFileHandle handle, long position, SeekOrigin origin) {
            int r;
            do {
