...
namespace EventStore.Core.Tests.Services.Replication.CommitTracking {
	[TestFixture]
	public class when_3_node_cluster_receives_index_write_notification : with_clustered_commit_tracker_service {
		...
		public override void When() {
			...
			Service.Handle(new CommitMessage.IndexWrittenTo(_logPosition));
