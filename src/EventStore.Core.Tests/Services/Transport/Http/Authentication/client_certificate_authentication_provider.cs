...
namespace EventStore.Core.Tests.Services.Transport.Http.Authentication {
	...
	[TestFixture]
	public class
		when_handling_a_request_with_a_client_certificate_having_an_ip_san :
			TestFixtureWithClientCertificateHttpAuthenticationProvider {
		private HttpAuthenticationRequest _authenticateRequest;
		private bool _authenticateResult;
		private HttpContext _context;
	...
	[TestFixture]
	public class
		when_handling_a_request_with_a_client_certificate_having_a_dns_san :
			TestFixtureWithClientCertificateHttpAuthenticationProvider {
		private HttpAuthenticationRequest _authenticateRequest;
		private bool _authenticateResult;
		private HttpContext _context;
	...
	[TestFixture]
	public class
		when_handling_a_request_with_a_client_certificate_having_a_non_dns_or_ip_san :
			TestFixtureWithClientCertificateHttpAuthenticationProvider {
		private HttpAuthenticationRequest _authenticateRequest;
		private bool _authenticateResult;
		private HttpContext _context;
