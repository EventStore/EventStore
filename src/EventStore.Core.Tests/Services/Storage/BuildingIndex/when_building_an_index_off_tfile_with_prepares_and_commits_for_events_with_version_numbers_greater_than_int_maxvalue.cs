...
{
    [TestFixture]
    public class when_building_an_index_off_tfile_with_prepares_and_commits_for_events_with_version_numbers_greater_than_int_maxvalue : ReadIndexTestScenario
    {
        private Guid _id1;
        private Guid _id2;
        private Guid _id3;
        ...
        protected override void WriteTestScenario()
        {
            ...
            Writer.Write(new PrepareLogRecord(0, _id1, _id1, 0, 0, "test1", firstEventNumber, DateTime.UtcNow,
                                              PrepareFlags.SingleWrite, "type", new byte[0], new byte[0], prepareRecordVersion: LogRecordVersion.LogRecordV1),
                         out pos1);
            ...
            Writer.Write(new PrepareLogRecord(pos2, _id3, _id3, pos2, 0, "test2", thirdEventNumber, DateTime.UtcNow,
                                              PrepareFlags.SingleWrite, "type", new byte[0], new byte[0], prepareRecordVersion: LogRecordVersion.LogRecordV1),
                         out pos3);
            Writer.Write(new CommitLogRecord(pos3, _id1, 0, DateTime.UtcNow, firstEventNumber, commitRecordVersion: LogRecordVersion.LogRecordV1), out pos4);
            Writer.Write(new CommitLogRecord(pos4, _id2, pos1, DateTime.UtcNow, secondEventNumber, commitRecordVersion: LogRecordVersion.LogRecordV1), out pos5);
            Writer.Write(new CommitLogRecord(pos5, _id3, pos2, DateTime.UtcNow, thirdEventNumber, commitRecordVersion: LogRecordVersion.LogRecordV1), out pos6);
        }
