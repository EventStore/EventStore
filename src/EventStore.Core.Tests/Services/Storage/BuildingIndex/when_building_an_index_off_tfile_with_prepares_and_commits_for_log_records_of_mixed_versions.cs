...
{
    [TestFixture]
    public class when_building_an_index_off_tfile_with_prepares_and_commits_for_log_records_of_mixed_versions : ReadIndexTestScenario
    {
        private Guid _id1;
        private Guid _id2;
        private Guid _id3;
        ...
        protected override void WriteTestScenario()
        {
            ...
            Writer.Write(new CommitLogRecord(pos4, _id2, pos1, DateTime.UtcNow, 0, LogRecordVersion.LogRecordV0), out pos5);
