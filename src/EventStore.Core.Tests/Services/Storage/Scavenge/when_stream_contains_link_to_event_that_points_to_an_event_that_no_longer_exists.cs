...
{
    [TestFixture]
    public class when_stream_contains_link_to_event_that_points_to_an_event_that_no_longer_exists : ScavengeTestScenario
    {
        protected override DbResult CreateDb(TFChunkDbCreationHelper dbCreator)
        {
            return dbCreator.Chunk(Rec.Prepare(0, "linkTo-Stream"),
                                   ...
                                   Rec.Prepare(2, "kept-stream"),
                                   Rec.Commit(2, "kept-stream"),
                                   Rec.Prepare(3, "test-stream"),
                                   Rec.Commit(3, "test-stream"))
                            .CompleteLastChunk()
                            .CreateDb();
        }
        ...
        {
            return new[] { 
                dbResult.Recs[0].Where((x, i) => new [] {0, 1, 4, 5, 6, 7}.Contains(i)).ToArray()
            };
        }
        ...
        [Test]
        public void the_link_to_event_is_absent_logically()
        {
            Assert.AreEqual(ReadEventResult.NotFound, ReadIndex.ReadEvent("linkTo-Stream", 1).Result);
        }

        [Test]
        public void the_link_to_event_is_absent_logically_reading_forward()
        {
        ...
        [Test]
        public void the_link_to_event_is_absent_logically_reading_backward()
        {
        ...
        [Test]
        public void the_link_to_event_is_absent_physically_reading_forward()
        {
        ...
        [Test]
        public void the_link_to_event_is_absent_physically_reading_backward()
        {
