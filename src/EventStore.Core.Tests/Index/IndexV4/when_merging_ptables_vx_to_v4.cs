...
namespace EventStore.Core.Tests.Index.IndexV4
{
    ...
    public class when_merging_ptables_vx_to_v4: SpecificationWithDirectoryPerTestFixture
    {
        ...
        public override void TestFixtureSetUp()
        {
            ...
            _newtable = PTable.MergeTo(_tables, _newtableFile, (streamId, hash) => hash + 1, x => true, x => new Tuple<string, bool>(x.Stream.ToString(), true), PTableVersions.IndexV4,skipIndexVerify: _skipIndexVerify);
        }
