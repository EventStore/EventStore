...
namespace EventStore.Core.Tests.Index.Scavenge
{
    ...
    public class when_scavenging_an_index_is_cancelled : SpecificationWithDirectoryPerTestFixture
    {
        ...
        public override void TestFixtureSetUp()
        {
            ...
            Assert.That(() => PTable.Scavenged(_oldTable, _expectedOutputFile, upgradeHash, existsAt, readRecord, PTableVersions.IndexV4, out spaceSaved, ct: cancellationTokenSource.Token), Throws.InstanceOf<OperationCanceledException>());
        }
