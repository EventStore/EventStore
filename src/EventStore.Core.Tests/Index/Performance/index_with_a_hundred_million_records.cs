...
namespace EventStore.Core.Tests.Index.Performance
{
    ...
    public class index_with_a_hundred_million_records : SpecificationWithFilePerTestFixture
    {
        ...
        protected int indexEntrySize = PTable.IndexEntryV3Size;

        public override void TestFixtureSetUp()
        {
            base.TestFixtureSetUp();
            _ptableCount = 1000000;
