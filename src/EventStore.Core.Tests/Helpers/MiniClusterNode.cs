		...
		public MiniClusterNode(
			...
			var singleVNodeSettings = new ClusterVNodeSettings(
				...
				new Data.GossipAdvertiseInfo(
					InternalTcpEndPoint.ToEventStoreEndPoint(),
					InternalTcpSecEndPoint.ToEventStoreEndPoint(),
					ExternalTcpEndPoint.ToEventStoreEndPoint(), ExternalTcpSecEndPoint.ToEventStoreEndPoint(),
					InternalHttpEndPoint.ToEventStoreEndPoint(), ExternalHttpEndPoint.ToEventStoreEndPoint(),
