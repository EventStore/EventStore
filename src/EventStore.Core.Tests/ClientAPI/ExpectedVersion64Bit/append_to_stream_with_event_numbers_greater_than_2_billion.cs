...
namespace EventStore.Core.Tests.ClientAPI.ExpectedVersion64Bit
{
    ...
    public class append_to_stream_with_event_numbers_greater_than_2_billion : MiniNodeWithExistingRecords
    {
        ...
        public override void Given()
        {
            ...
            _store.SetStreamMetadataAsync(StreamName, EventStore.ClientAPI.ExpectedVersion.Any, EventStore.ClientAPI.StreamMetadata.Create(truncateBefore: intMaxValue + 1)).Wait();
        }
