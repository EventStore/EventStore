...
namespace EventStore.Core.Tests.ClientAPI
{
    ...
    public class happy_case_writing_an_subscribing_to_normal_events_manual_ack : SpecificationWithMiniNode
    {
    ...
    [TestFixture, Category("LongRunning")]
    public class happy_case_writing_an_subscribing_to_normal_events_auto_ack : SpecificationWithMiniNode
    {
        private readonly string StreamName = Guid.NewGuid().ToString();
        private readonly string GroupName = Guid.NewGuid().ToString();
        private const int BufferCount = 10;
