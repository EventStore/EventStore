...
namespace EventStore.Core.Tests.TransactionLog
{
    ...
    public class prepare_log_record_should
    {
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => { new PrepareLogRecord(-1, Guid.NewGuid(), Guid.NewGuid(), 0, 0, "test", 0, DateTime.UtcNow,
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => { new PrepareLogRecord(0, Guid.NewGuid(), Guid.NewGuid(), -1, 0, "test", 0, DateTime.UtcNow,
                                 PrepareFlags.None, "type", new byte[0], null); });
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => { new PrepareLogRecord(0, Guid.NewGuid(), Guid.NewGuid(), 0, -2, "test", 0, DateTime.UtcNow,
                                 PrepareFlags.None, "type", new byte[0], null); });
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => { new PrepareLogRecord(0, Guid.Empty, Guid.NewGuid(), 0, 0, "test", 0, DateTime.UtcNow, 
                                 PrepareFlags.None, "type", new byte[0], null); });
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => { new PrepareLogRecord(0, Guid.NewGuid(), Guid.Empty, 0, 0, "test", 0, DateTime.UtcNow, 
                                 PrepareFlags.None, "type", new byte[0], null); });
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => { new PrepareLogRecord(0, Guid.NewGuid(), Guid.NewGuid(), 0, 0, null, 0, DateTime.UtcNow, 
                                 PrepareFlags.None, "type", new byte[0], null); });
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => { new PrepareLogRecord(0, Guid.NewGuid(), Guid.NewGuid(), 0, 0, string.Empty, 0, DateTime.UtcNow, 
                                 PrepareFlags.None, "type", new byte[0], null); });
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => { new PrepareLogRecord(0, Guid.NewGuid(), Guid.NewGuid(), 0, 0, "test", -3, DateTime.UtcNow, 
                                 PrepareFlags.None, "type", new byte[0], null); });
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => { new PrepareLogRecord(0, Guid.NewGuid(), Guid.NewGuid(), 0, 0, "test", 0, DateTime.UtcNow, 
