...
namespace EventStore.Core.Tests.TransactionLog.Truncation {
	...
	public class when_truncating_right_at_the_end_of_multichunk : SpecificationWithDirectoryPerTestFixture {
		...
		public override async Task TestFixtureSetUp() {
			...
			_config = TFChunkHelper.CreateDbConfig(PathName, 13500, chaserCheckpointPosition: 5500, epochCheckpointPosition: 5500, truncateCheckpoint: 11000, chunkSize: 1000);
