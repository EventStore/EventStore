...
namespace EventStore.Core.Tests.TransactionLog.Scavenging {
	...
	public class
		when_having_stream_with_both_max_age_and_max_count_with_stricter_max_age_specified_log_v3<TLogFormat, TStreamId> : ScavengeTestScenario<TLogFormat, TStreamId> {
