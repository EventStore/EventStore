...
namespace EventStore.Core.Tests.TransactionLog.Scavenging {
	...
	public class when_having_stream_with_strict_max_age_leaving_no_events_in_stream_log_v2<TLogFormat, TStreamId> : ScavengeTestScenario<TLogFormat, TStreamId> {
