...
namespace EventStore.Transport.Http.Codecs
{
    public static class Codec
    {
        ...
        public static readonly ICodec EventStoreXmlCodec = Codec.CreateCustom(Codec.Xml, ContentType.Atom, Helper.UTF8NoBom, false, false);
        public static readonly ICodec EventStoreJsonCodec = Codec.CreateCustom(Codec.Json, ContentType.AtomJson, Helper.UTF8NoBom, false, false);
        ...
        public static readonly CustomCodec CompetingXml = new CustomCodec(Xml, ContentType.Competing, Helper.UTF8NoBom, true, true);
        public static readonly CustomCodec CompetingJson = new CustomCodec(Json, ContentType.CompetingJson, Helper.UTF8NoBom, true, true);
