...
You can reset a projection using the reset button in the UI or through the [Projection HTTP API](https://developers.eventstore.com/http-api/v24.6/projections.html#projections-api).
