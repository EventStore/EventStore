...
Welcome to the EventStoreDB 21.10 documentation.
...
As the AtomPub protocol doesn't get any changes, you can use the v5 [HTTP API documentation](@clients/httpapi/introduction/README.md) for it.
