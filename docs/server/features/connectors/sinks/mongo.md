...
The MongoDB sink guarantees at least once delivery by retrying failed
...
The MongoDB sink supports transformation of event data before sending it
...
::: note
The MongoDB sink inherits a set of common settings that are used to configure the connector. The settings can
be found in
