...
Besides the common sink settings that can be found in the [Sink Options](../settings.md#sink-options) page, the Kafka sink connector supports additional settings related to resilience:
