...
KurrentDB-TrustedAuth: "root; admin, other"
```
...
| LDAP Server Unavailable                                                                     | Verify connectivity to the LDAP server from an KurrentDB node (e.g. using `netcat` or `telnet`). Verify the `Host` and `Port` parameters.                                                                                                                                                                                                                                                                                                    |
